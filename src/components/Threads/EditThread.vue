<template>
  ...
  >
    <PencilIcon class="h-4 w-4 inline-block hover:text-black hover:fill-current rounded cursor-pointer" />
  ...
  <ThemedModal :is-open="isModalOpen" @close-modal="closeModal">
    ...
    <div>
      ...
      /><label class="cursor-pointer font-semibold" for="lockThread">Lock Thread</label>
    </div>
